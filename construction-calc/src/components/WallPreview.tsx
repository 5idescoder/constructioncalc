...
const COLORS = {
  stud: new Color('#8B4513'),
  beam: new Color('#4169E1'),
  plate: new Color('#DEB887'),
  joist: new Color('#9370DB'),
  wall: new Color('#A0522D'),
  window: new Color('#87CEEB'),
  door: new Color('#8B0000'),
};

const LUMBER_DIMENSIONS = {
  stud: { width: 1.5, height: 5.5 },
  beam: { width: 1.5, height: 5.5 },
  plate: { width: 1.5, height: 3.5 },
  joist: { width: 1.5, height: 5.5 },
  wall: { width: 3.5, height: 8 },
  window: { width: 3, height: 4 },
  door: { width: 3, height: 6.67 },
};
